/****************************************************************************
** Meta object code from reading C++ file 'customcircleitem.h'
**
...
#error "The header file 'customcircleitem.h' doesn't include <QObject>."
...
void CustomGraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sceneClicked((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneMouseEvent*>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomGraphicsScene::*)(QGraphicsSceneMouseEvent * );
            if (_t _q_method = &CustomGraphicsScene::sceneClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomGraphicsScene::sceneClicked(QGraphicsSceneMouseEvent * _t1)
{
